    ...
    invoices: [
      {
        ...
        target_url: 'https://client.example/a',
        anchor_text: 'anchor a',
        native_amount: 100,
        native_currency: 'EUR',
        eur_amount: 100,
        presswhizz_price_eur: 110,
        savings_eur: 10,
        ecb_rate: 1,
      ...
      },
      {
        ...
        target_url: 'https://client.example/b',
        anchor_text: 'anchor b',
        native_amount: 200,
        native_currency: 'EUR',
        eur_amount: 200,
        presswhizz_price_eur: 220,
        savings_eur: 20,
        ecb_rate: 1,
        ecb_rate_as_of: '2026-04-01',
        conversion_status: 'converted',
      ...
      },
      {
        ...
        target_url: 'https://client.example/c',
        anchor_text: 'anchor c',
        native_amount: 50,
        native_currency: 'EUR',
        eur_amount: 50,
        presswhizz_price_eur: 55,
        savings_eur: 5,
        ecb_rate: 1,
