...
function row(
  ...
  return {
    ...
    website: null, website_raw: null, target_url: null, anchor_text: null, live_url: null,
    native_amount: spend, native_currency: 'EUR', eur_amount: Math.round(spend * 100) / 100,
    presswhizz_price_eur: null, savings_eur: savings, ecb_rate: 1,
